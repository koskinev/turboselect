...
/// variant is faster than `ternary_block_partition_right`.
///
    ...
    unsafe {
        ...
        while k > 0 {
            ...
            for offset in 0..(num_ge_low as u8) {
                ...
                let elem = data.get_unchecked(i - 1 - offset as usize);
