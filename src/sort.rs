    ...
    F: FnMut(&T, &T) -> bool,
{
    ...
    match N {
        ...
        21 => {
            sort2!(0, 1); sort2!(2, 3); sort2!(4, 5); sort2!(6, 7); sort2!(8, 9); sort2!(10, 11); 
            sort2!(12, 13); sort2!(14, 15); sort2!(16, 17); sort2!(18, 19); sort2!(0, 2); 
            sort2!(1, 3); sort2!(4, 6); sort2!(5, 7); sort2!(8, 10); sort2!(9, 11); 
            sort2!(12, 14); sort2!(13, 15); sort2!(16, 18); sort2!(17, 19); sort2!(1, 5); 
            sort2!(2, 6); sort2!(3, 15); sort2!(4, 16); sort2!(13, 17); sort2!(14, 18); 
            sort2!(1, 14); sort2!(2, 13); sort2!(3, 7); sort2!(5, 18); sort2!(6, 17); 
            sort2!(12, 16); sort2!(0, 16); sort2!(1, 2); sort2!(3, 19); sort2!(5, 13); 
            sort2!(6, 14); sort2!(17, 18); sort2!(0, 4); sort2!(5, 14); sort2!(6, 10); 
            sort2!(9, 13); sort2!(15, 19); sort2!(5, 8); sort2!(6, 12); sort2!(7, 13); 
            sort2!(11, 14); sort2!(2, 12); sort2!(7, 17); sort2!(8, 9); sort2!(10, 11); 
            sort2!(3, 9); sort2!(7, 11); sort2!(8, 12); sort2!(10, 16); sort2!(3, 10); 
            sort2!(4, 12); sort2!(7, 15); sort2!(9, 16); sort2!(7, 10); sort2!(9, 12); 
            sort2!(7, 9); sort2!(10, 12); sort2!(9, 10); sort2!(10, 20); sort2!(9, 10); 
        }
    ...
    F: FnMut(&T, &T) -> bool,
{
    ...
    match N {
        ...
        21 => { 
            ...
            sort2!(10, 11); sort2!(12, 13); sort2!(14, 15); sort2!(16, 17); 
            sort2!(18, 19); sort2!(0, 2); sort2!(1, 3); sort2!(4, 6); sort2!(5, 7); 
            sort2!(8, 10); sort2!(9, 11); sort2!(12, 14); sort2!(13, 15); 
            sort2!(16, 18); sort2!(17, 19); sort2!(0, 8); sort2!(1, 9); 
            sort2!(2, 10); sort2!(3, 11); sort2!(4, 12); sort2!(5, 13);
            sort2!(6, 14); sort2!(7, 15); sort2!(0, 4); sort2!(1, 5); sort2!(3, 7); 
            sort2!(6, 20); sort2!(8, 12); sort2!(9, 13); sort2!(10, 14); 
            sort2!(15, 19); sort2!(2, 6); sort2!(3, 18); sort2!(7, 20); 
            sort2!(2, 16); sort2!(3, 6); sort2!(5, 18); sort2!(7, 17); 
            sort2!(11, 20); sort2!(0, 2); sort2!(3, 8); sort2!(6, 12); 
            sort2!(7, 10); sort2!(9, 16); sort2!(11, 15); sort2!(13, 17);
            sort2!(14, 18); sort2!(19, 20); sort2!(1, 7); sort2!(2, 3); 
            sort2!(4, 9); sort2!(10, 11); sort2!(13, 16); sort2!(15, 18); 
            sort2!(17, 19); sort2!(1, 4); sort2!(5, 10); sort2!(6, 13); 
            sort2!(7, 8); sort2!(11, 14); sort2!(12, 16); sort2!(15, 17);
            sort2!(18, 19); sort2!(1, 2); sort2!(3, 4); sort2!(5, 6); 
            sort2!(10, 12); sort2!(11, 13); sort2!(14, 16); sort2!(17, 18);
            sort2!(2, 3); sort2!(4, 5); sort2!(6, 9); sort2!(10, 11); 
            sort2!(12, 13); sort2!(14, 15); sort2!(16, 17); sort2!(6, 7); 
            sort2!(8, 9); sort2!(15, 16); sort2!(4, 6); sort2!(7, 8); 
            sort2!(9, 12); sort2!(13, 15); sort2!(3, 4); sort2!(5, 7); 
            sort2!(8, 10); sort2!(9, 11); sort2!(12, 14); sort2!(5, 6); 
